...
__decorate([
    (0, typeorm_1.Column)({ default: 'fr', length: 2 }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.Column)({ name: 'blocked_until', type: 'timestamp', nullable: true }),
    (0, class_transformer_1.Exclude)(),
    __metadata("design:type", Date)
], User.prototype, "blockedUntil", void 0);
__decorate([
    (0, typeorm_1.ManyToMany)(() => role_entity_js_1.Role, (role) => role.users, { eager: true }),
